                      ...
                      <div class="col">
                        <div class="role">
                          ...
                          <input
                            ...
                            value="student"
                            id="studentRole"
                            @input="bg_registration = 'student.webp'"
                          />
                      ...
                      <div class="col">
                        <div class="role">
                          ...
                          <input
                            ...
                            v-model="registration.role"
                            value="parent"
                            @input="bg_registration = 'parent.webp'"
                          />
              ...
              <div class="card-body" :class="{ 'registration-card': formType == 'cta' }">
                  ...
                  <div class="col-md-12">
                    ...
                    <input
                      ...
                      :class="{
                        ...
                        'is-valid':
                          !shouldShowError('graduation_year') &&
                  ...
                  <div class="col-md-12" v-if="registration.have_child">
                    <div class="row g-3">
                      <div class="col-md-4">
                        ...
                        <input
                          ...
                          :class="{
                            ...
                            'is-valid':
                              !shouldShowError('secondary_name') &&
                              registration.secondary_name,
                          }"
                      ...
                      <div class="col-md-4">
                        ...
                        <input
                          ...
                          :class="{
                            ...
                            'is-valid':
                              !shouldShowError('secondary_phone') &&
                              registration.secondary_phone,
                          }"
                      ...
                      <div class="col-md-12">
                        ...
                        <small
                          class="text-danger error"
                          v-if="shouldShowError('school_id')"
                        >
                          {{ validate.school_id.$silentErrors[0]?.$message }}
                        </small>
                      </div>
                ...
                <div class="row mt-3">
                  <div class="col-md-12">
                    ...
                    <small
                      class="text-danger error"
                      v-if="shouldShowError('lead_source_id')"
                    >
  ...
  setup(props) {
    ...
    const nextAdditional = () => {
      ...
      if (check) {
        ...
        switch (registration.value.role) {
          case "parent":
            bg_registration.value = "parent.webp";
            break;
          case "student":
            bg_registration.value = "student.webp";
            break;
